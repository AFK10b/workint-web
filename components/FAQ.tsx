...
const faqs = [
  {
    ...
    a: "WorkInt launches on 1 January 2027. We're currently in closed beta, hand-picking early users from the waitlist. Sign up today to be among the first to get access — and lock in lifetime premium free.",
  },
  {
